export default function Card({ title, description, className, style, link }) {
  return (
    <div
      className={`w-64 h-96 bg-background border-2 border-border flex flex-col px-8 hover:scale-110 cursor-pointer transition-all items-center justify-evenly ${className}`}
      style={{ ...style }}
    >
